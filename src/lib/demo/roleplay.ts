...
export const DEMO_SCRIPTS: TalkScript[] = [
  {
    ...
    content: `## 受付突破
「お世話になっております。DARE BASE株式会社の◯◯と申します。**情報システムのご担当者様**はいらっしゃいますでしょうか。」
...
条件提示後は**こちらから話さない**。沈黙は相手が考えている時間。`,
  ...
  },
  {
    ...
    content: `## 基本の名乗り
「お世話になっております。DARE BASE株式会社の◯◯と申します。**◯◯部のご担当者様**はいらっしゃいますでしょうか。」

## 用件を聞かれたら
「営業体制の効率化についてのご案内で、**5分ほど**ご担当者様にお繋ぎいただけますでしょうか。」

## 断られたときの切り返し
- 「担当者に確認します」→「ありがとうございます。私、DARE BASEの◯◯と申します、と一言お伝えいただけますと幸いです。」
...
export const DEMO_ROLEPLAY_SESSIONS: RoleplaySession[] = [
  {
    ...
    duration_sec: 185,
    transcript:
      "お世話になっております。DARE BASE株式会社の鈴木と申します。情報システムのご担当者様はいらっしゃいますでしょうか。…実は同業の企業様で営業工数を30%削減した事例がございまして、ぜひ15分だけお時間をいただけないでしょうか。",
